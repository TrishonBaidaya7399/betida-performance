...
export default async function AntiMoneyLaundering() {
  const langCode = await getSystemLanguage();
  const t = await getTranslations("antiMoneyLaundering");
  const legalDoc = await fetchLegalDocument("antiMoneyLaundering");
