...
export default async function DepositBonusRequirements() {
  const langCode = await getSystemLanguage();
  const t = await getTranslations("depositBonusRequirements");
  const legalDoc = await fetchLegalDocument("depositBonusRequirements");
