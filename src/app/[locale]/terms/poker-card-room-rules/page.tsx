...
export default async function PokerCardRoomRulesPage() {
  const langCode = await getSystemLanguage();
  const t = await getTranslations("pokerCardRoomRules");
  const legalDoc = await fetchLegalDocument("pokerCardRoomRules");
